...
public class AluraServiceStack extends Stack {
    ...
    public AluraServiceStack(final Construct scope, final String id, final StackProps props, final Cluster cluster) {
        ...
        autenticacao.put("SPRING_DATASOURCE_URL",
                "jdbc:mysql://" + Fn.importValue("pedidos-db-endpoint") + ":3306/alurafood-pedidos?createDatabaseIfNotExist=true");
        ...
        IRepository iRepository = Repository.fromRepositoryName(this, "repositorioecr", "img-pedidos-ms");

        ApplicationLoadBalancedFargateService aluraService = ApplicationLoadBalancedFargateService.Builder.create(this, "JoaoService")
                .serviceName("joao-service-ola")
